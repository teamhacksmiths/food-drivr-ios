...
//        var HTTPBodyString = "{{\"user\": {\"phone\": \"6665555555\", \"name\": \"Test Driver2\"}}"
            ...
            var HTTPBodyString =
            "{\"user\": {\"phone\": \"+1 123 456 789\", \"description\": \"A dummy driver user\", \"name\": \"Driver User4\", \"email\": \"driver@hacksmiths.com\", \"company\": \"Hacksmiths\", \"avatar\": \"http://avatarurl.com\", \"role_id\": 1, \"setting_attributes\": {\"notifications\": true,\"active\": true}}}"
...
//            AuthService.sharedInstance.storeCurrentUser(userDict as! [String : AnyObject])
        ...
        userNameLabel.text = AuthService.sharedInstance.getCurrentUser()?.name
